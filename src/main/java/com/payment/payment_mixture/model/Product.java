package com.payment.payment_mixture.model;
...
public class Product implements Serializable {
	...
	private String outTradeNo;// 订单号(唯一,商户生成)
	private String tradeNo;// 订单号(唯一，支付宝生成)
	...
	public Product(String productId, String subject, String body,
			String totalFee, String outTradeNo,String tradeNo, String spbillCreateIp,
