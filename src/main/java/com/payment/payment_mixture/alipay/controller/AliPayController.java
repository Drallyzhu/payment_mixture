package com.payment.payment_mixture.alipay.controller;
...
public class AliPayController {
	...
	public String  query(Product product, ModelMap map){
		logger.info("电脑支付");
		String form  =  aliPayService.aliQuery(product);
		map.addAttribute("form", JSON.parse(form));
